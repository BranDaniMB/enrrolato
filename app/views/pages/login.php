...
<a class="google-login" href="<?php echo $auth->getAuthUrl() ?>">
    <img alt="Cambiar imagen" onmouseout="this.src='/enrrolato/public/images/btn_google_signin_dark_normal_web@2x.png';"
         onmouseover="this.src='/enrrolato/public/images/btn_google_signin_dark_focus_web@2x.png';"
         src="/enrrolato/public/images/btn_google_signin_dark_normal_web@2x.png"/>
</a>
